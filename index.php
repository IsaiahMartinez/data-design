...
<html lang="en-US">
	...
	<body>
		...
		<ul>
			<li>
				<strong>Name:</strong>James Horrox
			</li>
			<li>
				<strong>Gender:</strong>Male
			</li>
			<li>
				<strong>Age:</strong>56
			</li>
			<li>
		...
		<ol>
			...
			<li>
				The site verifies credentials and allows access.
			</li>
			<li>
				User begins writing and select post.
			</li>
			<li>
				System asks user to confirm they would like to post.
			</li>
			<li>
				User clicks yes to confirm the action.
			</li>
			<li>
				The site posts the users work.
			</li>
			<li>
				User clicks logout to exit the system.
			</li>
			<li>
